...
const _parseMillisecondsIntoReadableTime = (timestamp) => {
  ...
  const getAPI = async (lat, lon) => {
	...
	const data = await fetch(`http://api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${lon}&appid=282b3ebd9db3e69640faeb50d4dba8ed&units=metric&lang=nl&cnt=1`)
